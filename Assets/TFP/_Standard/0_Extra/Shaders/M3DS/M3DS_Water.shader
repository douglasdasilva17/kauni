...
Shader "M3DS/Water"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 PerturbNormal107_g26( float3 surf_pos, float3 surf_norm, float height, float scale )
			{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				float2 Input_UV145_g25 = panner4;
				...
				float4 Output_2D293_g25 = ( ( tex2Dlod( _HeightMap, float4( UV12_g25, 0, 0.0) ) * W12_g25 ) + ( tex2Dlod( _HeightMap, float4( UV22_g25, 0, 0.0) ) * W22_g25 ) + ( tex2Dlod( _HeightMap, float4( UV32_g25, 0, 0.0) ) * W32_g25 ) );
				float4 break31_g25 = Output_2D293_g25;
				...
				float2 Input_UV145_g24 = panner28;
				...
				float FineWaves100 = ( break31_g25.g + break31_g24.g );
				...
				float2 Input_UV145_g23 = panner73;
				...
				float LargeWaves101 = ( break31_g22.g + break31_g23.g );
						 ...
						 ) : SV_Target
			{
				...
				float3 surf_pos107_g26 = WorldPosition;
				float3 surf_norm107_g26 = WorldNormal;
				float localStochasticTiling2_g25 = ( 0.0 );
				float WaveSpeed43 = ( _TimeParameters.x * _WaveSpeed * 0.1 );
				float2 WaveDirection140 = _Wave1Direction;
				...
				float4 Output_2D293_g25 = ( ( tex2D( _HeightMap, UV12_g25, temp_output_10_0_g25, temp_output_12_0_g25 ) * W12_g25 ) + ( tex2D( _HeightMap, UV22_g25, temp_output_10_0_g25, temp_output_12_0_g25 ) * W22_g25 ) + ( tex2D( _HeightMap, UV32_g25, temp_output_10_0_g25, temp_output_12_0_g25 ) * W32_g25 ) );
				float4 break31_g25 = Output_2D293_g25;
				float localStochasticTiling2_g24 = ( 0.0 );
				float2 WaveDirection2201 = _Wave2Direction;
				float2 panner28 = ( WaveSpeed43 * WaveDirection2201 + ( WaveTileUV38 * 0.9 ).xy);
				...
				float lerpResult110 = lerp( ( FineWaves100 * _SmallWaveStrength ) , ( ( LargeWaves101 * 5.0 ) * _LargeWaveStrength ) , _WaveSizeBalance);
				float FinalWave106 = lerpResult110;
				float height107_g26 = FinalWave106;
				float scale107_g26 = _NormalStrength;
				float3 localPerturbNormal107_g26 = PerturbNormal107_g26( surf_pos107_g26 , surf_norm107_g26 , height107_g26 , scale107_g26 );
				float3x3 ase_worldToTangent = float3x3(WorldTangent,WorldBiTangent,WorldNormal);
				float3 worldToTangentDir42_g26 = mul( ase_worldToTangent, localPerturbNormal107_g26);
				float3 normalizeResult56 = normalize( worldToTangentDir42_g26 );
				float3 Normal150 = normalizeResult56;
				float eyeDepth = IN.ase_texcoord8.x;
				float eyeDepth28_g27 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ase_screenPosNorm.xy ),_ZBufferParams);
				float2 temp_output_20_0_g27 = ( (Normal150).xy * ( _RefractionStrength / max( eyeDepth , 0.1 ) ) * saturate( ( eyeDepth28_g27 - eyeDepth ) ) );
				float eyeDepth2_g27 = LinearEyeDepth(SHADERGRAPH_SAMPLE_SCENE_DEPTH( ( float4( temp_output_20_0_g27, 0.0 , 0.0 ) + ase_screenPosNorm ).xy ),_ZBufferParams);
				float2 temp_output_32_0_g27 = (( float4( ( temp_output_20_0_g27 * saturate( ( eyeDepth2_g27 - eyeDepth ) ) ), 0.0 , 0.0 ) + ase_screenPosNorm )).xy;
				float4 fetchOpaqueVal154 = float4( SHADERGRAPH_SAMPLE_SCENE_COLOR( temp_output_32_0_g27 ), 1.0 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 surf_norm107_g26 = ase_worldNormal;
				float localStochasticTiling2_g25 = ( 0.0 );
				float WaveSpeed43 = ( _TimeParameters.x * _WaveSpeed * 0.1 );
				float2 WaveDirection140 = _Wave1Direction;
				float4 appendResult10 = (float4(WorldPosition.x , WorldPosition.z , 0.0 , 0.0));
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				surfaceDescription.Alpha = ( -Depth161 + Edge137 );
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-5595.87,-452.9277;Inherit;True;Property;_WaveSpeed;Wave Speed;4;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;17;-5544.711,-1706.531;Inherit;False;Property;_WaveTile;Wave Tile;3;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;5;-5834.503,-1357.935;Inherit;False;Property;_Wave1Direction;Wave 1 Direction;15;0;Create;True;0;0;0;False;0;False;0,1;0.5,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.Vector2Node;200;-5826.983,-1186.669;Inherit;False;Property;_Wave2Direction;Wave 2 Direction;16;0;Create;True;0;0;0;False;0;False;0,1;1,-0.5;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.TexturePropertyNode;64;-5571.796,2853.746;Inherit;True;Property;_HeightMap;Height Map;10;0;Create;True;0;0;0;False;0;False;7667350b67a6e05408eab5d05068039b;1a7a9e141b92fe84e972535ec0345f29;False;gray;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.FunctionNode;74;-4168.792,4546.537;Inherit;False;Procedural Sample;-1;;23;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.FunctionNode;70;-4136.166,3110.276;Inherit;False;Procedural Sample;-1;;24;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
Node;AmplifyShaderEditor.SimpleAddOpNode;76;-3929.56,4466.091;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;69;-4126.802,2879.734;Inherit;False;Procedural Sample;-1;;25;f5379ff72769e2b4495e5ce2f004d8d4;2,157,0,315,0;7;82;SAMPLER2D;0;False;158;SAMPLER2DARRAY;0;False;183;FLOAT;0;False;5;FLOAT2;0,0;False;80;FLOAT3;0,0,0;False;104;FLOAT2;1,0;False;74;SAMPLERSTATE;0;False;5;COLOR;0;FLOAT;32;FLOAT;33;FLOAT;34;FLOAT;35
...
Node;AmplifyShaderEditor.RangedFloatNode;114;-3117.481,3894.19;Inherit;False;Property;_LargeWaveStrength;Large Wave Strength;14;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;115;-3108.481,3656.19;Inherit;False;Property;_SmallWaveStrength;Small Wave Strength;13;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;111;-3056.481,4064.19;Inherit;False;Property;_WaveSizeBalance;Wave Size Balance;12;0;Create;True;0;0;0;False;0;False;0.5;0.75;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;128;-2608.246,-108.1385;Inherit;False;Property;_NormalStrength;Normal Strength;8;0;Create;True;0;0;0;False;0;False;1.5;2;0;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.FunctionNode;53;-2286.09,-270.7726;Inherit;False;Normal From Height;-1;;26;1942fe2c5f1a1f94881a33d532e4afeb;0;2;20;FLOAT;0;False;110;FLOAT;1;False;2;FLOAT3;40;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;179;-1941.95,-1162.771;Inherit;False;Property;_WaterColorDepth;Water Color Depth;5;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;159;-3233.623,1534.704;Inherit;False;Property;_VisibilityDepth;Visibility Depth;7;0;Create;True;0;0;0;False;0;False;0.5;0.493;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;146;-3711.485,1011.444;Inherit;False;Property;_RefractionStrength;Refraction Strength;9;0;Create;True;0;0;0;False;0;False;0.5;0.25;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;208;-3318.598,1078.488;Inherit;False;DepthMaskedRefraction;-1;;27;c805f061214177c42bca056464193f81;2,40,0,103,0;2;35;FLOAT3;0,0,0;False;37;FLOAT;0.02;False;1;FLOAT2;38
...
Node;AmplifyShaderEditor.ColorNode;59;-1160.321,-1494.496;Inherit;False;Property;_DeepColor;Deep Color;2;0;Create;True;0;0;0;False;0;False;0.1117391,0.2199386,0.254717,1;0.1149429,0.3867924,0.345606,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;60;-1160.007,-1243.792;Inherit;False;Property;_ShallowColor;Shallow Color;1;0;Create;True;0;0;0;False;0;False;0.2736739,0.4617023,0.4716981,1;0.23487,0.5236304,0.5471698,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.OneMinusNode;174;-2539.729,1528.515;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;193;-836.1754,-2180.16;Inherit;False;Property;_EdgeFadeDistance;Edge Fade Distance;6;0;Create;True;0;0;0;False;0;False;0.2;0.2;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;198;-42.64716,352.6791;Inherit;False;Property;_WaveHeight;Wave Height;11;0;Create;True;0;0;0;False;0;False;0;2;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;214;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;0;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;215;417.4008,-28.8386;Float;False;True;-1;2;UnityEditor.ShaderGraphLitGUI;0;12;M3DS/Water;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;20;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;2;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;2;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Transparent=RenderType;Queue=Transparent=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalForward;False;False;0;;0;0;Standard;41;Workflow;1;638247972673289389;Surface;1;638247973248659378;  Refraction Model;0;638247972702772931;  Blend;0;0;Two Sided;0;638247971523781677;Fragment Normal Space,InvertActionOnDeselection;0;0;Forward Only;0;638247973157381578;Transmission;0;638247973144051984;  Transmission Shadow;0.5,False,;0;Translucency;0;638247973132832187;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;0;LOD CrossFade;1;0;Built-in Fog;1;0;_FinalColorxAlpha;0;638247973003477019;Meta Pass;1;638247972490943634;Override Baked GI;0;0;Extra Pre Pass;0;0;DOTS Instancing;0;0;Tessellation;1;638247971408421140;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;1;638247971644207939;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;Debug Display;0;0;Clear Coat;0;0;0;10;False;True;True;True;True;True;True;True;True;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;216;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;False;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=ShadowCaster;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;217;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;False;False;True;True;False;False;False;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;False;False;True;1;LightMode=DepthOnly;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;218;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;219;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=Universal2D;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;220;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthNormals;0;6;DepthNormals;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;1;False;;0;False;;0;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;False;;True;3;False;;False;True;1;LightMode=DepthNormals;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;221;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;GBuffer;0;7;GBuffer;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;True;1;5;False;;10;False;;1;1;False;;10;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;1;LightMode=UniversalGBuffer;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;222;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;SceneSelectionPass;0;8;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;2;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;223;417.4008,-28.8386;Float;False;False;-1;2;UnityEditor.ShaderGraphLitGUI;0;1;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ScenePickingPass;0;9;ScenePickingPass;0;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;4;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;UniversalMaterialType=Lit;True;5;True;12;all;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;1;LightMode=Picking;False;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.GetLocalVarNode;190;96.0825,171.5227;Inherit;False;137;Edge;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.NegateNode;225;49.13635,-170.1668;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;227;179.1364,-239.1668;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;228;-34.86365,-27.16681;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
WireConnection;215;0;167;0
WireConnection;215;1;151;0
WireConnection;215;4;50;0
WireConnection;215;6;227;0
WireConnection;215;8;197;0
WireConnection;225;0;169;0
WireConnection;227;0;225;0
WireConnection;227;1;190;0
WireConnection;228;0;190;0
WireConnection;228;1;169;0
ASEEND*/
//CHKSM=5587F42225F36A214C169DA973E1934687871A41